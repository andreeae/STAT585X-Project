...
% 		\item APEX model
%     \end{itemize}
\item study data: 2003-2007, frame designed in 2003
\end{itemize}
\lyxframeend{}
...
\pause
\includegraphics[width=4cm, height=2.5cm]{images/census.jpg}
\pause
\\

\includegraphics[width=4cm, height=2.5cm]{images/PLSS.jpg}
\pause
...
\item smaller dimensions, except for Public Land Survey System (PLSS) 
