...
\item propotions of missing records in 2004 and 2005 due to clouds and to undefined records
\item changes in some important crops over the years, for example corn and soybeans
  \begin{itemize}

  \item corn proportion of land is lower in 2003 and 2005
  \item soybean proportion of land is higher in 2003
